        ...
        const fetchReports = async () => {
            try {
                ...
                if (data.success && data.data.length > 0) {
                    ...
                    setReports([
                        { id: 1, reportedBy: "@abc_here", email: "abc_4@ex.com", title: "Failing to submit Q file", msg: "failing to submit Q file", type: "bug", priority: "high", status: "unresolved", date: "08 Apr 2026" },
                        { id: 2, reportedBy: "@Siddhi_T", email: "coco10@ex.com", title: "Wrong option in Q2 neet", msg: "wrong option in Q2 neet", type: "content", priority: "medium", status: "unresolved", date: "07 Apr 2026" },
                        { id: 3, reportedBy: "@xyz_T", email: "xyz_67@ex.com", title: "Wont save points", msg: "wont save points", type: "bug", priority: "high", status: "unresolved", date: "05 Apr 2026" },
                        { id: 4, reportedBy: "@unknown_here", email: "unk_90@ex.com", title: "Profile pic not updating", msg: "profile pic not updating", type: "ui", priority: "low", status: "resolved", date: "01 Apr 2026" },
                    ]);
                }
            } catch (err) {
