        ...
        const fetchUsers = async () => {
            try {
                ...
                if (data.success && data.data.length > 0) {
                    ...
                    setUsers([
                        { id: 1, username: "@Siddharth_V", email: "sidd34@ex.com", points: "15,840", role: 'student', is_active: true },
                        { id: 2, username: "@Siddhi_T", email: "sidt74@ex.com", points: "14,840", role: 'student', is_active: true },
                        { id: 3, username: "@Soham_T", email: "coco10@ex.com", points: "13,840", role: 'instructor', is_active: true },
                    ]);
                }
            } catch (err) {
