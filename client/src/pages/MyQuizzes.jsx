        ...
        <div className="max-w-[1200px] mx-auto text-black dark:text-white pt-6 pb-20 px-4 lg:px-0">
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 mb-6">
                ...
                <div className="flex items-center border border-gray-600/50 rounded-lg overflow-hidden">
                    ...
                    <button onClick={() => setViewMode('list')} className={`p-2.5 transition-colors ${viewMode === 'list' ? 'bg-[#475569] text-white' : 'bg-[#1a1d2e] text-gray-400 hover:text-white'}`} title="List view">
