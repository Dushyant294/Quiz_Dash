...
class QuizModel {
  ...
  static async createFile(data) {
    const { uploaded_by, file_name, file_url, subject, topic, micro_topic, question_count, status } = data;
    const result = await db.query(
      `INSERT INTO question_files (uploaded_by, file_name, file_url, subject, topic, micro_topic, question_count, status)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
      [uploaded_by, file_name, file_url, subject, topic, micro_topic, question_count || 0, status || 'Draft']
    );
